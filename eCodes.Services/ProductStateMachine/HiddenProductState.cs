...
{
    public class HiddenProductState : ProductBaseState
    {
        public HiddenProductState(IMapper mapper, IServiceProvider serviceProvider, _210331Context context) : base(mapper, serviceProvider, context)
        {
        }
